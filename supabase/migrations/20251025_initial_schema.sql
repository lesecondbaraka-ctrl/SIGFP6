...
-- Politiques pour entites (lecture publique pour utilisateurs authentifiés)
...
-- Politiques pour utilisateurs (lecture propre profil + admin)
...
-- Politiques pour logs (écriture libre, lecture admin)
...
-- Politiques pour les tables de configuration (lecture publique)
